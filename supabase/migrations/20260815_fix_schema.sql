-- Run this once in the Supabase SQL Editor to enable bottle units + categories.
...
alter table public.items
  ...
  check (unit in ('pcs', 'bottle', 'bags', 'packets', 'boxes', 'kg', 'g', 'L', 'ml'));
...
-- 3) Best-effort backfill from item names
